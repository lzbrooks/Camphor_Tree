email = {
    ...
    "payload": {
        ...
        "filename": "",
        "headers": [
            {"name": "Delivered-To", "value": "test_recipient@gmail.com"},
            {
                "name": "Received",
            ...
            {"name": "Return-Path", "value": "\u003ctest_sender@gmail.com\u003e"},
            {
                "name": "Received",
            ...
            {"name": "From", "value": "Test Person \u003ctest_sender@gmail.com\u003e"},
            {"name": "To", "value": "\u003ctest_recipient@gmail.com\u003e"},
            {
                "name": "References",
            ...
            {"name": "Subject", "value": "RE: Info (1/1)"},
            {"name": "Date", "value": "Fri, 10 Jun 2022 20:29:57 -0400"},
            {
                "name": "Message-ID",
            ...
            {"name": "X-Mailer", "value": "Microsoft Outlook 14.0"},
            {"name": "Thread-Index", "value": "AQKv4ED6dovhUtA2+/dshqzVBgmwZ6uak3nA"},
            {"name": "Content-Language", "value": "en-us"},
            {
                "name": "X-Antivirus",
                "value": "AVG (VPS 220610-4, 6/10/2022), Outbound message",
            },
            {"name": "X-Antivirus-Status", "value": "Clean"},
        ],
        "body": {
            "size": 520,
