...
def test__dissect_message__no_parts():
    sut = GMailMessage(
        max_message_size="250", message_whitelist=["test_sender@gmail.com"]
    )
    message_from, message_subject, message_text = sut._dissect_message(
        bob_skipped_email.email["payload"]
    )
